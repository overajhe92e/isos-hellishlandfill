SMODS.Booster {
    ...
    loc_txt = {
        ...
        text = {
            ...
            "Does not include {C:fizz_finalrgb}Terminus{}, {C:fizz_ust}Cursed{}, or {C:attention}Unique{} Jokers",
        },
        group_name = "Garbage"
    },
...
SMODS.Booster {
    ...
    loc_txt = {
        ...
        text = {
            "Choose {C:attention}#1#{} of {C:attention}#2#{} Iso. Junkyard Jokers",
            "{C:attention}Include{} {C:fizz_finalrgb}Terminus{}, {C:fizz_ust}Cursed{}, and/or {C:attention}Unique{} Jokers",
        },
